                            ...
                            <div class="remember">
                                ...
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}"
                                       class="forgot"> {{__('auth.login_page.forgot_my_password')}}</a>
                                @endif
                            </div>
                            <button type="submit" class="btn btn-lg btn-green full-width"> {{__('auth.login')}}</button>
                            <p>{{__('auth.login_page.donot_have_account')}} <a href="{{route('register')}}"
                                                                               style="color: blue; text-decoration: underline;">{{__('auth.login_page.register_now')}}</a> {{__('auth.login_page.start_enjoing_benefits')}}
                            </p>
