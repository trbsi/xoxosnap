                            ...
                            <div class="form-group">
                                <div class="form-group label-floating">
                                    ...
                                    <textarea class="form-control" name="description"
                                              rows="3">{{$media->getOriginal('description')}}</textarea>
                            ...
                            <div class="form-group">
                                <div class="form-group label-floating">
                                    <button class="btn btn-green btn-md-2"
                                            type="submit">{{__('web/home/home.performer_video_form.submit')}}</button>
                                    <button class="btn btn-secondary btn-md-2" type="button"
                                            id="cancel-edit-video-button">{{__('web/home/home.performer_video_form.cancel')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
