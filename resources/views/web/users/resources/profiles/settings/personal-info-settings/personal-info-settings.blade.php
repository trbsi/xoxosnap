    ...
    <div class="col col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
        <div class="ui-block">
            ...
            <div class="ui-block-content">
                ...
                <form method="POST" action="{{route('web.user.profile.settings.edit-personal-info-settings')}}"
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group label-floating is-select">
                                ...
                                <div class="file-upload">
                                    <label for="upload" class="file-upload__label bg-blue"
                                           id="upload-button-text">{{__('web/users/resources/settings.personal_info.profile_picture')}}</label>
                                    <input class="file-upload__input" type="file" name="picture"
                                           id="profile-picture-input-file">
                                </div>
                                <div style="display: none; font-weight: bold;" id="chosen-picture">
                                    {{__('web/users/resources/settings.personal_info.chosen_picture')}}: <span
                                            id="chosen-picture-name"></span>
                                    |
                                    <a href="javascript:;"
                                       id="remove-chosen-picture">{{__('web/users/resources/settings.personal_info.remove_chosen_picture')}}</a>
                                </div>
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="date" name="birthday"
                                       value="{{old('birthday') ?? $authUser->profile->getOriginal('birthday')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="current_city"
                                       value="{{old('current_city') ?? $authUser->profile->getOriginal('current_city')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="business_email"
                                       value="{{old('business_email') ?? $authUser->profile->getOriginal('business_email')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="website"
                                       value="{{old('website') ?? $authUser->profile->getOriginal('website')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="facebook"
                                       value="{{old('facebook') ?? $authUser->profile->getOriginal('facebook')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="twitter"
                                       value="{{old('twitter') ?? $authUser->profile->getOriginal('twitter')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <input type="text" name="instagram"
                                       value="{{old('instagram') ?? $authUser->profile->getOriginal('instagram')}}">
                            ...
                            <div class="form-group label-floating is-select">
                                ...
                                <textarea type="text" name="description" class="form-control"
                                          rows="10">{{old('description') ?? $authUser->profile->getOriginal('description')}}</textarea>
