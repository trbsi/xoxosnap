                ...
                <article class="post">
                    ...
                    <ol>
                        <li>
                            ...
                            <p>Whenever you participate to a private or semi-private live stream on the Platform your written communications as well as the live streams may be monitored and/or recorded by {{config('app.name')}} for the purpose of ensuring compliance with all applicable laws as well as the <a href="{{route('terms-of-use')}}" class="is-link">Terms and Conditions for Users and Members</a> and our <a href="{{route('terms-of-use')}}" class="is-link">Terms of Service for Uploaders</a>.  Your participation to a live stream will be associated with your account and profile, IP address and device ID for the purpose of providing you with the Services.</p>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>to ensure compliance with the <a href="{{route('terms-of-use')}}" class="is-link">Terms and Conditions for Users and Members</a> and the <a href="{{route('terms-of-use')}}" class="is-link">Terms of Service for Uploaders</a>;</li>
