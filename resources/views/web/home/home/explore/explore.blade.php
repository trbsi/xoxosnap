                    ...
                    <div class="ui-block">
                        <div class="ui-block-title inline-items">
                            <div class="btn btn-control btn-control-small bg-orange">
                                <svg class="olymp-new">
                                    <use xlink:href="/assets/svg-icons/sprites/icons.svg#olymp-new"></use>
                                </svg>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="btn-group btn-group-justified grouped-buttons-full-width" role="group"
                     style="display: flex;">
                    <a href="{{route('web.explore', ['type' => Media::ORDER_TYPE_RECENT])}}"
                       class="btn {{(Media::ORDER_TYPE_RECENT === $exploreType) ? 'btn-primary' : 'btn-secondary'}}">
                        {{__('web/home/explore.recent_videos')}}
                    </a>
                    <a href="{{route('web.explore', ['type' => Media::ORDER_TYPE_ENDING_SOON])}}"
                       class="btn {{(Media::ORDER_TYPE_ENDING_SOON === $exploreType) ? 'btn-primary' : 'btn-secondary'}}">
                        {{__('web/home/explore.ending_soon_videos')}}
                    </a>
                    <a href="{{route('web.explore', ['type' => Media::ORDER_TYPE_MOST_VIEWED])}}"
                       class="btn {{(Media::ORDER_TYPE_MOST_VIEWED === $exploreType) ? 'btn-primary' : 'btn-secondary'}}">
                        {{__('web/home/explore.most_viewed_videos')}}
                    </a>
                    <a href="{{route('web.explore', ['type' => Media::ORDER_TYPE_MOST_PAID])}}"
                       class="btn {{(Media::ORDER_TYPE_MOST_PAID === $exploreType) ? 'btn-primary' : 'btn-secondary'}}">
