...
<div class="tab-pane {{(null === request()->query('section')) ? 'active' : ''}}" id="video" role="tabpanel"
     aria-expanded="true">
    <form enctype="multipart/form-data" id="video-form" method="POST">
        ...
        <div class="row" style="padding: 15px;">
            ...
            <div class="col col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="form-group is-select">
                    <select class="selectpicker form-control" name="expires_in_type" disabled>
                        <option value="{{Media::EXPIRY_TIME_MINUTES}}"
                                selected="">{{__('web/home/home.performer_video_form.minutes')}}</option>
            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group label-floating">
                    ...
                    <textarea name="description" class="form-control" placeholder=""
                              style="border: 1px solid #E9E9E9;"></textarea>
                </div>
            </div>
            ...
            <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="form-group">
                    ...
                    <div class="file-upload">
                        <label for="upload"
                               class="file-upload__label">{{__('web/home/home.performer_video_form.choose_video')}}</label>
                        <input class="file-upload__input" type="file" id="video-form-media-to-upload" accept="video/mp4"
                               name="video">
                    </div>
                    <br>
            ...
            <div class="add-options-message">
                <button class="btn btn-green btn-md-2" type="submit"
                        id="upload-video-form-btn">{{__('web/home/home.performer_video_form.upload_video')}}</button>
                <button class="btn btn-secondary btn-md-2" type="button"
                        id="reset-video-form-button">{{__('web/home/home.performer_video_form.reset')}}</button>
            </div>
        </div>
    </form>
</div>
