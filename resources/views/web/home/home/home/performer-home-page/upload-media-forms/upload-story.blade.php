...
<div class="tab-pane {{('add-story' === request()->query('section')) ? 'active' : ''}}" id="story" role="tabpanel"
     aria-expanded="true">
    <form id="story-form">
        <div class="row" style="padding: 15px;">
            ...
            <div class="col col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                <div class="form-group is-select">
                    <select class="selectpicker form-control" name="expires_in_type">
                        <option value="{{Story::EXPIRY_TIME_MINUTES}}"
            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="file-upload ">
                    <label for="upload"
                           class="file-upload__label">{{__('web/home/home.performer_story_form.choose_video_or_image')}}</label>
                    <input class="file-upload__input" type="file" name="stories[]" id="story-form-media-to-upload"
                           multiple>
                </div>
            </div>
        ...
        <div class="add-options-message">
            <button class="btn btn-green btn-md-2"
                    id="upload-story-form-button">{{__('web/home/home.performer_story_form.upload_story')}}</button>
            <button class="btn btn-secondary btn-md-2" type="button"
                    id="reset-story-form-button">{{__('web/home/home.performer_story_form.reset')}}</button>
        </div>
    </form>
</div>
