                    ...
                    <ul class="statistics-list-count">
                        <li>
                            ...
                            <div class="count-stat">
                                <div>NC{{$currentCoins}} <span
                                            class="indicator positive"> {{__('general/site.coins')}}</span></div>
                                <div>${{$currentMoney}} <span
                                            class="indicator positive"> {{__('general/site.dollars')}}</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
