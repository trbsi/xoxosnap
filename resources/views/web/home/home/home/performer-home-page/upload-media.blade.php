                    ...
                    <div class="tab-content">
                            ...
                            <form enctype="multipart/form-data" id="video-form" method="POST">
                            	...
                            	<div class="row" style="padding: 15px;">
		                            ...
		                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
										...
										<div class="radio">
											<label>
												<input type="radio" value="never" name="expiry" checked>
												{{__('web/home/home.performer_video_form.expires_never')}}
											</label>
										</div>
										<div class="radio">
											<label>
												<input type="radio" value="custom" name="expiry">
		                            ...
		                            <div class="col col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
		                                <div class="form-group">
											...
											<div class="file-upload">
												...
												<input class="file-upload__input"  type="file" id="file-to-upload" accept="video/mp4" name="video" data-url="server/php/">
											</div>
											<br>
                        ...
                        <div class="tab-pane" id="story" role="tabpanel" aria-expanded="true">
                            <form>
                                ...
                                <div class="add-options-message">
                                    <button class="btn btn-primary btn-md-2">{{__('web/home/home.performer_video_form.upload_story')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
$(function () {
    ...
    $('#file-to-upload').fileupload({
        ...
        url: 'some/url',
        add: function (e, data) {
            processVideoAndPrepareForThumbnail(data);
            uploadVideoBtn.click(function() {
	            var validated = validateInput();
	            if (false === validated) {
	            	return;
...
/*document.querySelector("#file-to-upload").addEventListener('change', function() {
	processVideo(document.querySelector("#file-to-upload"));
});*/
...
function validateInput()
{
	...
	if (false === $('input[name="expiry"]').is(':checked')) { 
		showErrorMessage('{{__('web/home/home.performer_video_form.expiry')}}');
		validated = false;
	} else {
		if ('custom' === $('input[name="expiry"]:checked').val() && '' === $('input[name="expires_in"]').val()) {
