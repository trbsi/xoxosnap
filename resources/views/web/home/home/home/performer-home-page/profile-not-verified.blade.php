        ...
        @if (UserVerification::STATUS_UNVERIFIED === $user->verification->status)
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="alert alert-warning text-center">
                    ...
                    <div class="img-circular mx-auto"
                         style="opacity: 0.6; background-image: url('{{$user->profile->picture}}');">
                    ...
                    <form method="POST" action="{{route('web.user.verification.request-verification')}}"
                          enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div class="file-upload">
                                <label for="upload"
                                       class="file-upload__label bg-blue">{{__('web/home/home.performer.not_verified.choose_photo')}}</label>
                        ...
                        <div class="form-group">
                            <button type="submit"
                                    class="btn btn-green btn-md">{{__('web/home/home.performer.not_verified.send')}}</button>
                        </div>
                    </form>
                </div>
            </div>
