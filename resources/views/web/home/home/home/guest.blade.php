...
<div class="container">
    <div class="row">
        ...
        <div class="col col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <a href="{{route('web.social.login', ['provider' => 'twitter'])}}"
               class="btn btn-lg bg-twitter full-width btn-icon-left"><i class="fab fa-twitter"
                                                                         aria-hidden="true"></i>{{__('auth.login_with_twitter')}}
            </a>
        </div>
        <div class="col col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            ...
            <a href="{{route('register')}}" class="btn btn-purple btn-md full-width">{{__('auth.register')}}
                <div class="ripple-container"></div>
            </a>
            <h4><b>{{__('web/home/home.guest.login_as_performer_viewer')}}</b></h4>
            <a href="{{route('login')}}" class="btn btn-green btn-md full-width">{{__('auth.login')}}
                <div class="ripple-container"></div>
            </a>
        </div>
    </div>
                    ...
                    <div class="ui-block-title inline-items">
                        <div class="btn btn-control btn-control-small bg-yellow">
                            <svg class="olymp-trophy-icon">
                                <use xlink:href="/assets/svg-icons/sprites/icons.svg#olymp-trophy-icon"></use>
                            </svg>
                        </div>
                        ...
                        <div class="friend-item-content">
                            <div class="friend-avatar">
                                ...
                                <div class="author-content">
                                    <a href="{{$performer->profile_url}}"
                                       class="h5 author-name">{{$performer->name}}</a>
                                    <a href="{{$performer->profile_url}}">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        ...
                                        <div class="control-block-button" data-swiper-parallax="-100">
                                            <a href="javascript:;" data-name="{{$performer->name}}"
                                               class="btn btn-control bg-blue follow_performer_button">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <ul>
                                            <li><b>{{__('web/home/home.guest.gender')}}
                                                    :</b> {{$performer->profile->gender}}</li>
                                            <li><b>{{__('web/home/home.guest.website')}}:</b>
                                                @if(empty($performer->profile->website))
                                                    -
                                                @else
                                                    <a href="{{$performer->profile->website}}"
                                                       target="_blank">{{__('web/home/home.guest.visit_website')}}</a>
                                                @endif
                                            </li>
                                        </ul>
                                        </p>
