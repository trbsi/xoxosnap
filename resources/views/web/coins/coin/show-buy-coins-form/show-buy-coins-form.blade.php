            ...
            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="ui-block">
                    ...
                    <div class="ui-block-content">
                        <form class="needs-validation" id="buy-coins-form" method="POST"
                              action="{{route('api.coins.process-coins-order')}}">
                            @csrf
                            <div class="row">
                                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div>
                                        <b>{{__('web/coins/coins.show_buy_coins_form.total_in_dollars')}}: <span
                                                    id="in-dollars"></span></b>
                                    </div>
                                    <br>
                                </div>
                                <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <button class="btn btn-md btn-green"
                                            type="submit">{{__('web/coins/coins.show_buy_coins_form.buy')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
