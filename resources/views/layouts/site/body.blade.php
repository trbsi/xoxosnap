    ...
    <ul id="menu" class="mfb-component--br mfb-zoomin" data-mfb-toggle="click">
      <li class="mfb-component__wrap">
        ...
        <ul class="mfb-component__list">
          <li>
            <a href="{{env('TWITTER_LINK')}}" target="_blank" data-mfb-label="Visit us on Twitter" class="mfb-component__button--child">
              <i class="mfb-component__child-icon fab fa-twitter fa-3x"></i>
            </a>
          </li>
          <li>
            <a href="{{env('INSTAGRAM_LINK')}}" target="_blank" data-mfb-label="Visit us on Instagram" class="mfb-component__button--child">
              <i class="mfb-component__child-icon fab fa-instagram fa-3x"></i>
            </a>
          </li>

          <li>
            <a href="{{env('DISCORD_LINK')}}" target="_blank" data-mfb-label="Visit us on Discord" class="mfb-component__button--child">
